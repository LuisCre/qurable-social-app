...
export const FORMATS = {
  ...
  'yt-cover':      { width: 2560, height: 1440, label: 'Cover (2560×1440)' },
  'yt-short':      { width: 1080, height: 1920, label: 'Short (9:16)' },
}
...
export const PLATFORMS = {
  ...
  yt: { label: 'YouTube',   formats: ['yt-cover', 'yt-short'],      types: ['Cover', 'Short'] },
}
